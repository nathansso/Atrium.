...
export function patchLaserDataTls(laserRoot, iggyRoot) {
...
if (process.argv[1] && resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  ...
  const patched = patchLaserDataTls(laserRoot, iggyRoot);
  console.log(patched
    ? "LaserData TLS patch applied for @laserdata/laser-sdk 0.0.1."
    : "LaserData TLS patch skipped: installed SDK versions do not need this pinned workaround.");
}
